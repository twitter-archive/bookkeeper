...
public class BookkeeperServerStatsLogger extends BookkeeperStatsLogger {
    public static enum BookkeeperServerOp {
        ...
        BOOKIE_ADD_ENTRY, BOOKIE_RECOVERY_ADD_ENTRY, BOOKIE_READ_ENTRY, BOOKIE_READ_LAST_CONFIRMED,
        BOOKIE_ADD_ENTRY_BYTES, BOOKIE_READ_ENTRY_BYTES,
        ...
        GC_NUM_LEDGERS_DELETED_PER_GC, GC_NUM_ENTRYLOGS_DELETED_PER_COMPACTION,
        CHANNEL_WRITE
    }

    public static enum BookkeeperServerCounter {
        JOURNAL_WRITE_BYTES, JOURNAL_QUEUE_SIZE, READ_BYTES, WRITE_BYTES,
        NUM_MINOR_COMP, NUM_MAJOR_COMP, NUM_GC,
        INDEX_INMEM_ILLEGAL_STATE_RESET, INDEX_INMEM_ILLEGAL_STATE_DELETE,
        ...
        LEDGER_CACHE_NUM_EVICTED_LEDGERS,
        GC_NUM_LEDGERS_DELETED, GC_NUM_ENTRYLOGS_DELETED, GC_NUM_ENTRYLOGS_COMPACTED,
    }
    ...
    public static enum BookkeeperServerGauge {
        ...
        NUM_PENDING_ENTRY_LOG_FILES, LEAST_UNFLUSHED_ENTRYLOG_ID, CURRENT_ENTRYLOG_ID,
        GC_TOTAL_SCANNED_BYTES, GC_TOTAL_SCANNED_ENTRYLOG_FILES, GC_LAST_SCANNED_ENTRYLOG_ID,
        GC_NUM_ENTRYLOG_FILES_SPACE_USAGE,
        SERVER_STATUS
    }
