...
public class MultipleThreadReadTest extends MultiLedgerManagerMultiDigestTestCase {
    ...
    //TODO(Aniruddha): Remove this class and change the way concurrent requests are handled.
    class SyncObj {
    ...
    public MultipleThreadReadTest(String ledgerManagerFactory, BookKeeper.DigestType digestType) {
        super(3);
            ...
            public void run() {
                try {
                    ...
                    lh.asyncReadEntries(0, entriesPerLedger - 1, new AsyncCallback.ReadCallback() {
                        @Override
                        public void readComplete(int rc, LedgerHandle ledgerHandle, Enumeration<LedgerEntry> list, Object o) {
                            SyncObj syncObj = (SyncObj) o;
                            try {
                                if (rc != BKException.Code.OK) {
    ...
    public void multiLedgerMultiThreadRead(final int numLedgers,
        ...
        final int entriesPerLedger = 100;
