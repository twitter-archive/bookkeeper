...
public class MultiplexSubscribeResponseHandler extends SubscribeResponseHandler {
    ...
    class ActiveSubscriber implements SubscriptionListener {
        ...
        ActiveSubscriber(TopicSubscriber ts, PubSubData op,
            ...
            deliveryHandler.setOrigSubData(op);
        }
        ...
        void startDelivery(MessageHandler messageHandler)
        ...
        void asyncMessageDeliver(Message message) {
        ...
        private void handleMessageDeliveryException() {
            // if failed to deliver messages, the simple way is to disconnect the channel
            // which would trigger reconnect logic.
            // TODO (sijie): since it was a multiplex channel, it could be improved to reconnect
            // single subscriber in fine granuarity.
            channel.close();
        }
    }
